...
<body style="background: ghostwhite;">
	<div id="wrapper" style="background-color: ghostwhite">
		...
		<div id="wp-content">
			...
			<p>Cảm ơn quý khách đã đặt hàng tại Camera Kuma Đấu La</p>
			<div style="display: flex; justify-content: center;" class="a"><a href="trangchuController">Tiếp tục mua hàng ➔</a></div>
		</div>
