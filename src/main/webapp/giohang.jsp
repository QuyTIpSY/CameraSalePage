					...
					if(ghbo!=null){%>
						...
						<tr>
							...
							<td style="padding: 20px 0px;">
								<a style="border: 1px solid red;background: red;color: white;font-size: 20px;font-weight: bold;padding: 5px;" href="thanhtoanController">Thanh toán</a>
							</td>
						</tr>
						
					<%}else{ %>
						<tr>Gio hàng trống, xin mời <a href="trangchuController">MUA HÀNG</a></tr>
					<%} %>
			</table>	
			<%} %>
		</div>
